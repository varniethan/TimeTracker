<div>
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#timeoff_categories" data-whatever="@getbootstrap">Add Holiday Code</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="timeoffCategoriesLabel">Add Holiday Category</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="uploadTab">
                            <form method="POST" action="{{url('holiday_type')}}" class="form-horizontal form-label-left" id="openTab">
                                @csrf
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="defaultCheck1">Is this paticular type of holiday payed?</label>
                                </div>
...
<table class="table table-striped">
    ...
    <tbody>
    @foreach($holidayTypeData as $holidayType)
        <tr>
            <th scope="row">{{$loop->iteration}}</th>
            <td>{{$holidayType->name}}</td>
            <td>{{$holidayType->description}}</td>
            <td>{{$holidayType->is_payed}}</td>
            <td>{{$holidayType->pay_rate}}</td>
            <td>{{$holidayType->status}}</td>
        </tr>
    @endforeach
    </tbody>
</table>
