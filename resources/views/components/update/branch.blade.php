...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title"><h2>Branch Profile <small>Edit Details</small></h2><ul class="nav navbar-right panel_toolbox"><li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li></ul><div class="clearfix"></div></div>
            <div class="x_content">
                <div class="row">
                    <span class="section">{{$branchData['name']}} - {{$branchData['display_name']}}</span>
                    <div class="col-sm">
                        <form method="POST" action="/timeTracker/public/organisation/{{ $branchData['id'] }}">
                            {{ method_field('PATCH') }}
                            @csrf
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">Organisation Name<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="name" value="{{$branchData['name']}}" required="required" disabled/>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="display_name" value="{{$branchData['display_name']}}" required="required" />
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="email" name="email"  class="form-control" value="{{$branchData['email']}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="mobile_number" class="form-control" value="{{$branchData['mobile_number']}}">
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="land_number" class="form-control" value="{{$branchData['land_number']}}">
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="postal_code"   class="form-control" value="{{$branchData['postal_code']}}">
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="address_1" class="form-control" value="{{$branchData['address_1']}}">
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="address_2" class="form-control" value="{{$branchData['address_2']}}">
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <select class="form-select col-md-6 col-sm-6" id='sel_city' name='city' aria-label=".form-select-sm example">
                                    <option value='{{$branchData['city']}}'>{{\App\Models\City::getCityName($branchData['city'])}}</option>
                    ...
                    <div class="col-sm">
                        ...
                        <ul class="list-unstyled user_data">
                            ...
                            <li><i class="fa fa-building user-profile-icon"></i>{{$branchData['name']}}</li>
                            <li class="m-top-xs">
                                <i class="fa fa-external-link user-profile-icon"></i>
                                <a href="http://www.kimlabs.com/profile/" target="_blank">www.kimlabs.com</a>
                            </li>
                        </ul>
                        <a class="btn btn-primary" href="{{url('/branch')}}"><i class="fa fa-eye m-right-xs"></i>View Profile</a><br>
                    </div>
                </div>
