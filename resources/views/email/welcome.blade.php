                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title">Welcome to Time Tracker!</td>
                                    </tr>
                                </table>
                                            ...
                                            <table class="status" bgcolor="#fffeea" cellspacing="0">
                                                <tr>
                                                    <td class="status-cell">
                                                        Activation code: <b>13448278949</b>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table class="body">
                                    <tr>
                                        ...
                                        <td class="body-padded">
                                            <div class="body-title">Hey , {{$details['first_name']}}thanks for signing up</div>
                                            <table class="body-text">
                                                <tr>
                                                    <td class="body-text-cell">
                                                        {{'First of all, welcome. And thanks for opening a Time Tracker account. We hope that Time Tracker will become something that you use everyday'}}
                                                        {{'Time Tracker is different from other types of apps, so we have put together some information to help you get started.'}}
