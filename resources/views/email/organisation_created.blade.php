                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title">{{$details['organisation_name']}} has been added</td>
                                    </tr>
                                </table>
                                <table class="body">
                                    <tr>
                                        ...
                                        <td class="body-padded">
                                            <div class="body-title">Hi {{$details['first_name']}},</div>
                                            <table class="body-text">
                                                <tr>
                                                    <td class="body-text-cell">
                                                        Your have sucessfully added your Organisation. Start Time Tracking now. For any queries please <a href="#">contact support</a>.
                                                    </td>
                                                </tr>
                                            </table>
                                            <div><!--[if mso]>
                                            ...
                                            <table class="body-signature-block">
                                                <tr>
                                                    <td class="body-signature-cell">
                                                        ...
                                                        <p class="body-signature"><img src="/public/assets/images/signature.png" alt="Time Tracker Team"></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
